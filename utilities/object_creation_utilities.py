...
def create_pot_and_assign_to_user(user: Users, location, plant_name, desired_humidity, watering_frequency,
                                  additional_attributes, pot_name: str = "Unnamed group", ):
    pot = SmartPots.create_pot(location=location, plant_name=plant_name, desired_humidity=desired_humidity,
